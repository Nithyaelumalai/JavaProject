...
public class Main {
	...
	public static void main (String args[]) {
		Pojo p=new Pojo(1,"Niffy","Nithya","login issue","to do");
		Pojo p1=new Pojo(2,"Sabi","Sabitha","server slow","done");
		Pojo p2=new Pojo(3,"Sandy","santhiya","user name wrong ","testing");
